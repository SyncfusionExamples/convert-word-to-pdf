...
The repository contains a Console Application to convert word document to PDF by using [Syncfusion&reg; Word to PDF converter](https://www.syncfusion.com/document-processing/word-framework/net/word-to-pdf-conversion?utm_source=github&utm_medium=listing&utm_campaign=github-docio-examples)
...
- **Documentation:** [Convert Word to PDF using Syncfusion&reg; Word library](https://help.syncfusion.com/file-formats/docio/word-to-pdf?utm_source=github&utm_medium=listing&utm_campaign=github-docio-examples)
