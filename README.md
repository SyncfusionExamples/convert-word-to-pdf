...
The repository contains a Console Application to convert word document to PDF by using [Word to PDF converter](https://www.syncfusion.com/document-sdk/net-word-library/word-to-pdf-conversion)
